...
//        }
    ...
    public void gameDemo() {
        ...
        mServerProxy.returnDestinationCards(christian.getUsername(), game1.getGameName(), cards1);
        cards3 = new DestinationCard[2];
        cards1[0] = player3.getDestinationCardHand().get(0);
        cards1[1] = player3.getDestinationCardHand().get(1);
